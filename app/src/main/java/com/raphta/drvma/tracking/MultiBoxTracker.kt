...
package com.raphta.drvma.tracking
...
import com.raphta.drvma.Classifier.Recognition
...
class MultiBoxTracker(private val context: Context) {
    ...
    private fun handleDetection(
        ...
        val potentialObject = objectTracker!!.trackObject(potential.second.getLocation(), timestamp, frameCopy)
